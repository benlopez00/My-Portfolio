		...
		<div className="p-2 w-full flex flex-col items-center font-sans bg-transparent">
			<div className="grid gap-6 z-40" style={{ gridTemplateColumns: 'repeat(4, 270px)', gridAutoRows: '270px' }}>
				...
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/berlinTvTower.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/trainTracks.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/bremenAerial.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
				<Card className="col-span-2 row-span-1 card py-8 px-12 bg-light2 dark:bg-dark2">
					<CardBody className="p-0 h-full">
						<div className="w-full h-full flex flex-col text-justify justify-around">
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
								Ya de vuelta en Tucumán y en la universidad, la pandemia me encontró sin mucho animo estudiando economía. Fue entonces que comencé a adentrarme en la programación y el diseño de interfaces
							</Typography>
						</div>
					</CardBody>
				</Card>
				...
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/werderStadium.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/hamburgRathaus.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
				<Card className="col-span-2 row-span-2 card py-8 px-12 bg-light2 dark:bg-dark2">
					<CardBody className="p-0 h-full">
						<div className="w-full h-full flex flex-col text-justify justify-center gap-16">
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
								Deseoso de visitar nuevamente Alemania, aplique a una visa working-holiday. Una vez ahí, trabajé durante un año en Adata Software GmbH en Verden, Baja Sajonia.
							</Typography>
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
							...
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
								Durante ese tiempo, me enfrenté a desafíos técnicos (<em className="italic">lingüísticos</em>) y creativos, pero cada tarea me dejó una enorme satisfacción.
							</Typography>
						</div>
					</CardBody>
				</Card>
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/werderWesser.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>			
				<Card className="col-span-2 row-span-2 card py-8 px-12 bg-light2 dark:bg-dark2">
					<CardBody className="p-0 h-full flex flex-col items-start gap-5">
						<Typography variant="h2" className="font-nyght-serif font-[500]  text-light7 dark:text-dark7">
						...
						<div className="w-full h-full flex flex-col text-justify justify-center gap-16">
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
								Estoy enfocado en seguir aprendiendo en las áreas donde necesito más preparación y certificar mis conocimientos.
							</Typography>
							<Typography className="font-sans text-[16px] font-normal text-light7 dark:text-dark7">
				...
				<Card className="col-span-1 row-span-2 card bg-light2 dark:bg-dark2 overflow-hidden">
					<img src="/lubeckChurch.jpg" alt="Big Ben" className="w-full h-full" loading="lazy"/>
				</Card>
